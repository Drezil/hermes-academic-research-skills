...
```json
{
  ...
  "stages": {
    ...
    "2": { "name": "WRITE", "skill": "hermes-academic-paper", "status": "completed", "mode": "plan -> full", "outputs": ["Paper Draft (5,200 words, IMRaD)"], "...": "same standard fields as stage \"1\"" },
    "2.5": {
      "name": "INTEGRITY",
    ...
    "3": {
      "name": "REVIEW",
      "skill": "hermes-academic-paper-reviewer",
      "status": "completed",
      "mode": "full",
    ...
    "3p": { "name": "RE-REVIEW", "skill": "hermes-academic-paper-reviewer", "status": "completed", "mode": "re-review", "decision": "accept", "outputs": ["Re-Review Report", "Editorial Decision: Accept"], "...": "same standard fields as stage \"3\"" },
    "4p": {
      "name": "RE-REVISE",
      "skill": "hermes-academic-paper",
      "status": "skipped",
