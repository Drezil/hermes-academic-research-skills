...
DEFAULT_FORMATTER = REPO_ROOT / "hermes-academic-paper/agents/formatter_agent.md"
DEFAULT_ORCHESTRATOR = REPO_ROOT / "hermes-academic-pipeline/agents/pipeline_orchestrator_agent.md"
