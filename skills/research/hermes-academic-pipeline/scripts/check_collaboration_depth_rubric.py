...
ORCHESTRATOR_PATH = Path("hermes-academic-pipeline/agents/pipeline_orchestrator_agent.md")
PIPELINE_SKILL_PATH = Path("hermes-academic-pipeline/SKILL.md")
AGENTS_DIR = Path("hermes-academic-pipeline/agents")
