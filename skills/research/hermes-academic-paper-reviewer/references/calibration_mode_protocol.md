...
**Status**: v3.2
**Parent skill**: `hermes-academic-paper-reviewer`
...
- **Factual form** — *same-source hallucination*: when the model that wrote the work and the model verifying it share training data, a fabricated reference that "feels right" passes undetected. This is the citation-integrity risk documented in the Anti-Hallucination Mandate (`hermes-academic-pipeline/agents/integrity_verification_agent.md`), countered there by independent reference lookup.
...
- ARS `hermes-academic-paper-reviewer/references/quality_rubrics.md` — scoring rubric definitions.
