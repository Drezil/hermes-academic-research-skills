...
Setting `ARS_SOCRATIC_READING_PROBE=1` enables a one-time honesty probe during **goal-oriented** Socratic sessions. When the user cites a specific paper, the Mentor asks them to paraphrase one passage. Decline is logged without penalty. Default OFF. See `references/agents/socratic_mentor_agent.md` §"Optional Reading Probe Layer".
...
|-------|----------------|
| research_question_agent | `references/agents/research_question_agent.md` |
| research_architect_agent | `references/agents/research_architect_agent.md` |
| bibliography_agent | `references/agents/bibliography_agent.md` |
| source_verification_agent | `references/agents/source_verification_agent.md` |
| synthesis_agent | `references/agents/synthesis_agent.md` |
| report_compiler_agent | `references/agents/report_compiler_agent.md` |
| editor_in_chief_agent | `references/agents/editor_in_chief_agent.md` |
| devils_advocate_agent | `references/agents/devils_advocate_agent.md` |
| ethics_review_agent | `references/agents/ethics_review_agent.md` |
| socratic_mentor_agent | `references/agents/socratic_mentor_agent.md` |
| risk_of_bias_agent | `references/agents/risk_of_bias_agent.md` |
| meta_analysis_agent | `references/agents/meta_analysis_agent.md` |
| monitoring_agent | `references/agents/monitoring_agent.md` |
