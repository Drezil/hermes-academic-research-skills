...
This example demonstrates the complete workflow of `review` mode. The user provides a previously written policy recommendation summary, and hermes-deep-research activates three review agents for multi-dimensional review.
