...
def test_kong_258_agent_and_formatter_markers_present():
    timeline_agent = (REPO_ROOT / "hermes-deep-research/agents/timeline_extraction_agent.md").read_text()
    draft_writer = (REPO_ROOT / "hermes-academic-paper/agents/draft_writer_agent.md").read_text()
    formatter = (REPO_ROOT / "hermes-academic-paper/agents/formatter_agent.md").read_text()
...
def test_kong_258_design_doc_documents_127_boundary_and_example_exists():
    ...
    example = REPO_ROOT / "hermes-academic-paper/examples/version_family_reconciliation_example.md"
