...
See `hermes-academic-paper-reviewer/SKILL.md` for review process details.
...
See `hermes-academic-paper-reviewer/SKILL.md` Re-Review Mode for verification review process.
