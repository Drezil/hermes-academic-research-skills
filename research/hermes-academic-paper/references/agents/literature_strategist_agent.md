...
You are a single-phase agent assigned to **hermes-academic-paper Phase 1 (Literature)** — analogous to `bibliography_agent`'s Phase 2 work in hermes-deep-research, but scoped to the hermes-academic-paper writing pipeline. Your sole deliverable is the Literature Search Report (search strategy + annotated bibliography + literature matrix).
...
Reference: `hermes-academic-paper/references/domain_evidence_profiles.md`
...
**Backpointer**: see [`hermes-academic-pipeline/references/literature_corpus_consumers.md`](../../hermes-academic-pipeline/references/literature_corpus_consumers.md) for the full consumer protocol, BAD/GOOD examples, and shared template.
...
| `hermes-deep-research` (Handoff) | Annotated Bibliography | APA 7.0 format annotated bibliography |
...
- **Handoff receiving rules**: Bibliography received from hermes-deep-research goes directly to Phase B (full-text assessment), skipping Phase A
