...
- `hermes-academic-paper/agents/formatter_agent.md` — R-L3-2-A + R-L3-2-E (in the contamination pass-through paragraph).
- `hermes-deep-research/references/crossref_api_protocol.md` — R-L3-2-A (user-discretion reference).
- `hermes-deep-research/references/openalex_api_protocol.md` — R-L3-2-A reference.
- `hermes-academic-pipeline/agents/pipeline_orchestrator_agent.md` — R-L3-2-C / R-L3-2-D / R-L3-2-E (finalizer logic).
- `hermes-deep-research/agents/bibliography_agent.md` — R-L3-2-B (ingest-time computation).
...
- `hermes-deep-research/agents/synthesis_agent.md` (`<AGENT>` = "synthesis agent")
- `hermes-deep-research/agents/report_compiler_agent.md` (`<AGENT>` = "compiler"; R-CIM-B carries an extra standalone-mode sentence — see prompt)
- `hermes-academic-paper/agents/draft_writer_agent.md` (`<AGENT>` = "writer")
