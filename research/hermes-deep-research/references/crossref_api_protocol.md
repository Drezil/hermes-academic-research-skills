...
- Mirror template: `hermes-deep-research/references/semantic_scholar_api_protocol.md`
- Sibling protocol: `hermes-deep-research/references/openalex_api_protocol.md`
