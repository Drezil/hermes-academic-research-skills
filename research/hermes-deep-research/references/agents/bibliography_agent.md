...
- `openalex_unmatched` — per `hermes-deep-research/references/openalex_api_protocol.md`
- `crossref_unmatched` — per `hermes-deep-research/references/crossref_api_protocol.md`
